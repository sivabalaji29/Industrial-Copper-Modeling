...
<div style='text-align:center'>
    <h1 style='color:white;'>Industrial Copper Modeling</h1>
...
with tab1:    
        ...
        with st.form("my_form"):
            ...
            with col3:               
                st.write( f'<h5 style="color:rgb(0, 147, 112, 219);">NOTE: Min & Max given for reference, you can enter any value</h5>', unsafe_allow_html=True )
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"C:\Users\SIVABALAJI S\Desktop\copper\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'C:\Users\SIVABALAJI S\Desktop\copper\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:\Users\SIVABALAJI S\Desktop\copper\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:\Users\SIVABALAJI S\Desktop\copper\s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"C:\Users\SIVABALAJI S\Desktop\copper\cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'C:\Users\SIVABALAJI S\Desktop\copper\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"C:\Users\SIVABALAJI S\Desktop\copper\ct.pkl", 'rb') as f:
